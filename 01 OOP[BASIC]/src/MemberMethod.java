 ...
 *     2.멤버메쏘드 선언(행위)    
 *        접근제한자 리턴타입 메쏘드이름(인자){
 *           -인자(parameter): 나를 호출한놈이 데이타를 넣어줄 통로 
...
public class MemberMethod {
	...
	void method1(){
		...
		/*
		 * -모든 메소드의 마지막에는 항상 실행흐름(스레드)을 호출한 곳으로 반환 하여야 한다
		 * - return type이 void인 경우, 생략이 가능하다
		 */
		return;
	...
	void method4(String name,String msg, int count) {
		System.out.println("method4(String name,String msg,int count)");
