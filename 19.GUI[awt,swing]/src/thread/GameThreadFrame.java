...
public class GameThreadFrame extends JFrame {
	...
	public GameThreadFrame() {
		...
		for (int i = 0; i < penguinImgs.length; i++) {
			Toolkit.getDefaultToolkit().getImage("penguin1.jpg");
			penguinImgs[i] = 
	...
	private Image[] penguinImgs; //펭귄이미지 3개
	int pX,pY; //펭귄의 위치
	int imageNo; // 펭귄의 이미지 번호
	int direction;//펭귄의 이동 방향
	boolean isPlay; //펭귄스레드 작동 여부
	...
	/******* member inner class[KeyListener imp]********/
