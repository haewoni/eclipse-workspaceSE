...
public class LocalVariableInitializationMain {
	...
	public static void main(String[] args) {
		...
		LocalVariableInitialization m1= 
			new LocalVariableInitialization(1,"KIM");
		m1.print();
		...
		m3.print();
		m4.print();
		if(m3==m4) { //m3와 m4의 type이 동일해야함// 
			System.out.println("m3와 m4의 주소값이 동일하다");
		}else {
			System.out.println("m3와 m4의 주소값이 동일하지 않다");
		}
		
		LocalVariableInitialization firstMember= 
				new LocalVariableInitialization (1111,"FRIST");
		LocalVariableInitialization secondMember= 
				new LocalVariableInitialization (2222,"SECOND");
		firstMember.print();
		secondMember.print();
