...
public class StringMain {
	...
	public static void main(String[] args) {
		...
		System.out.println("name1과 name2의 주소값이 동일 하지 않다" + isEqual);
		/*
		 * String 객체의 암시적 생성 ""을 사용 double quotation
		 * 
		 */
		String str1 = "자바";
		String str2 = "자바";
		...
		if (str1 != str3) {
			System.out.println("str1과 str2의 주소가 동일하지 않다");
		}
		if ("자바" == "자바") {
			System.out.println("\"자바\"과 \"자바\"의 주소가 동일하다");
		}
		System.out.println("-----------String 객체의 문자열 내용 비교---------------");
		/*
		 * << String >> public boolean equals (object anObject) -문자열 비교로 재정의
		 */
		if (str1.equals(str2)) {
