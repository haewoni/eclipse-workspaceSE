...
public class MemberDao {
	...
	private ArrayList<Member> readFile() throws Exception {
		ObjectInputStream ois = new ObjectInputStream(new FileInputStream(membersFile));
	 ...
	 * create
	 */
	public boolean create(Member addMember) throws Exception { // DTO,VO
	 ...
	 * readAll
	 */
	public ArrayList<Member> readAll() throws Exception { // DTO,VO Collection
	 ...
	 * readOne
	 */
	public Member readOne(String id) throws Exception{ // DTO,VO
