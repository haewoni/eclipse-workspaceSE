...
public class PrimitiveTypeArrayStudentMain {
	...
	public static void main(String[] args) {
		System.out.println("------------------학생 데이터를 저장하기 위한 배열 객체 생성 초기화--------------------");
		...
		int[] matha= {90,56,34,67,23,88,99,78,55,87};
		...
		System.out.println(">>> 학점이 F인 학생들 찾아서 출력");
		...
		System.out.println(">>> 총점 순 오름차순 정렬");
		/*
		 * 1회
		 */
