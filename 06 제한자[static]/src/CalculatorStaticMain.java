...
public class CalculatorStaticMain {
	...
	public static void main(String[] args) {
		/*
		 * << The constructor Calculator() is not visible >> Calculator calculator=new
		 * Calculator(); int r = calculator.add(1,2); System.out.println(r); int r =
		 * calculator.sub(1,2); System.out.println(r); int r = calculator.div(1,2);
		 * System.out.println(r); int r = calculator.mul(1,2); System.out.println(r);
		 */
